...
public class MyForegroundService extends Service {
    ...
    private final long period = 2000; //2s                  // Co ile ma być wykonywana praca cykliczna
    ...
    public void onCreate() {
        ...
        // Stworzenie obiektu licznika
        timer = new Timer();

        // Utworzenie zadania licznika
    ...
    // Odczytywanie wartości przekazane w obiekcie Intencji i uruchamianie metody doWork
    @Override
...
*/
    ...
    // Metoda tworząca kanał dla Notification
